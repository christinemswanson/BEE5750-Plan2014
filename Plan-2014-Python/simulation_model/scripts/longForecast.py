...
args = sys.argv
# args = ["", "stochastic", "sqLM", "12month", "1"]
...
if (
    ...
    for i in range(len(filelist)):
        ...
        for p in range(nseeds):
            ...
            if skill == "sq":
                longForecast = statusquo[
                    ["sm", "qm", "sqNTS", "indicator", "confidence"]
                ]
            ...
            # -----------------------------------------------------------------------------
                ...
                longForecast = synthetic[
                    ["sm", "qm", "synNTS", "indicator", "confidence"]
                ]
                longForecast.columns = [
                    "Sim",
                    "QM",
    ...
    for i in range(len(filelist)):
        ...
        if skill == "sqAR":
            ...
            # save forecasts
            longForecast = longForecast.loc[
                :, ["Sim", "QM", "forNTS", "indicator", "confidence"]
            ]
            ...
            longForecast["xStand"] = (
                longForecast["x"] - longForecast["mu_x"]
            ) / longForecast["sigma_x"]
